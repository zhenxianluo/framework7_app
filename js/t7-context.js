  ...
  register:[
  	{
  		...
  		title: "性别",
  		input: "<input type='radio' name='sex' value='male'>男<input type='radio' name='sex' value='female'>女"
  	},{
  		title: "出生日期",
  		input: "<input type='text' placeholder='YYYY-MM-DD' readonly id='picker-date'>"
  	}
  ],
  // 左侧面板的#menuList
  menuList:[
